...
#define DEVICE_NAME                      "iBeacon"                          /**< Name of device. Will be included in the advertising data. */
...
#define BEACON_TX_POWER_LEVEL						0xB3
...
#define APP_MAJOR_VALUE                 0x2E, 0x79                        /**< Major value used to identify Beacons. */ 
#define APP_MINOR_VALUE                 0x06, 0xFA                        /**< Minor value used to identify Beacons. */ 
